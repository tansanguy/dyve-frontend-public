        ...
        <div className="space-y-8">
          ...
          {isTerms ? (
            <>
              ...
              <Section title="6. 입장과 현장 신분증 검사">
                <p>업장은 행사마다 현장 신분증 직접 검사 필요 여부를 선택하고, 필요한 경우 직원이 실물 신분증을 직접 확인합니다.</p>
                <p>DYVE QR은 입장 자격과 결제·취소 상태를 확인하며, 신분증 진위나 이용자의 나이를 판정하지 않습니다.</p>
                <p>관련 법령 준수, 직원 교육과 최종 입장 판단은 업장 운영 책임입니다. 이 확인은 관계 법령에 따른 DYVE의 책임을 배제하지 않습니다.</p>
              </Section>
              <Section title="7. 금지행위와 이용 제한">
            ...
            <>
              <Section title="1. 처리 목적과 항목">
                ...
                <p>입장 운영 과정에서 주민등록증 등 신분증 이미지, 신분증 번호, 생년월일 또는 얼굴정보를 수집하거나 저장하지 않습니다. 현장 신분증 검사는 필요한 경우 업장 직원이 실물 신분증으로 직접 진행합니다.</p>
              </Section>
